...
public class ArticleParagraphApiController {
  ...
  public ResponseEntity<ArticleParagraph> save(
      @PathVariable Long articleId, @Valid @RequestBody ArticleParagraphRequest request) {
  ...
  public ResponseEntity<String> translateParagraph(
    ...
    String translated =
        articleParagraphService.translateParagraph(
            AdminUtils.getCurrentAdminId(authentication), textEn);
