...
public class AuditAwareImpl implements AuditorAware<Admin> {
    ...
    public Optional<Admin> getCurrentAuditor() {
        ...
        // findById() tìm full admin trong khi hibernate chỉ cần id để set cho admin ToeicTest => getReferenceById() chỉ tạo proxy object (object giả) chỉ chứa id, khi nào cần cái khác thì mới query
