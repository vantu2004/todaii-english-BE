package com.todaii.english.server.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ResponseBody
  public ResponseEntity<GlobalErrorDTO> handleBusinessException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  @ResponseBody
  public GlobalErrorDTO handleConstrainViolationException(
    ...
    constraintViolations.forEach(
        constraintViolation -> globalErrorDTO.addError(constraintViolation.getMessage()));
  ...
  @ResponseBody
  public GlobalErrorDTO handleJwtValidationException(
