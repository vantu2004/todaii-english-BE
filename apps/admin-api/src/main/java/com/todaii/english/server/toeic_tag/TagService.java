...
public class TagService {
  ...
  public ToeicTag create(String name, String partNumbers) {
    ...
    ToeicTag tag = ToeicTag.builder().partNumbers(partNumbers).name(name).alias(alias).build();

    return tagRepository.save(tag);
  }

  public ToeicTag update(Long id, String name, String partNumbers) {
    ...
    tag.setPartNumbers(partNumbers);
    tag.setName(name);
    tag.setAlias(alias);
