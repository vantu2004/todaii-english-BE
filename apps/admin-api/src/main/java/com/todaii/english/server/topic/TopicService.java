...
public class TopicService {
  ...
  public Page<Topic> findAllPaged(
      int page, int size, String sortBy, String direction, String keyword, String topicType) {
  ...
  public Topic findById(Long id) {
    return topicRepository
        .findById(id)
        .orElseThrow(() -> new BusinessException(404, "Topic not found"));
  }
  ...
  private String toAlias(String name, TopicType topicType) {
    return topicType.toString().toLowerCase()
        + "-"
