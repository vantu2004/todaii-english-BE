...
public class VocabDeckGeneratorService {
	...
	public VocabDeck autoGenerateDeckWords(Long deckId) {
		...
		Set<String> wordSet = createSuggestedWords(deck).stream().map(String::trim).map(String::toLowerCase)
	...
	private Set<String> createSuggestedWords(VocabDeck deck) {
	...
	private void handleMissingWords(Set<String> missingWords, Set<DictionaryEntry> finalWords) {
		try {
