...
public class ArticleApiController {
  ...
  public ResponseEntity<PagedResponse<Article>> getArticlesByDate(
    ...
    Page<Article> articles =
        articleService.getArticlesByDate(parsedDate, keyword, page, size, sortBy, direction);
  ...
  public ResponseEntity<PagedResponse<Article>> search(
      ...
      @RequestParam(required = true)
          ...
          @Length(max = 1024, message = "Keyword must not exceed 1024 characters")
          String keyword) {
  ...
  public ResponseEntity<List<Article>> getRelatedArticles(
      @PathVariable Long id, @RequestParam(defaultValue = "5") @Min(1) int limit) {
  ...
  @GetMapping("/filter")
  public ResponseEntity<PagedResponse<Article>> filterArticles(
      @RequestParam(required = false) String keyword,
      ...
      @RequestParam(defaultValue = "desc") String direction) {
    Page<Article> articles =
        articleService.filterArticles(
            keyword, sourceName, cefrLevel, minViews, alias, page, size, sortBy, direction);
