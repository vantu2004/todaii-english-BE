...
import com.todaii.english.core.entity.vocabulary.VocabDeck_;
import com.todaii.english.core.entity.vocabulary.VocabGroup;
import com.todaii.english.core.entity.vocabulary.VocabGroup_;
...
public class VocabDeckSpecification {
  public static Specification<VocabDeck> hasKeyword(String keyword) {
    return (root, query, cb) -> {
      ...
      return cb.or(
          cb.like(cb.lower(root.get(VocabDeck_.NAME)), likeValue),
  ...
  public static Specification<VocabDeck> hasCefrLevel(CefrLevel cefrLevel) {
    return (root, query, cb) ->
        cefrLevel == null ? null : cb.equal(root.get(VocabDeck_.cefrLevel), cefrLevel);
  }
